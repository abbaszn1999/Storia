...
const contentTypes = [
  {
    ...
    description: "Create AI-powered videos with multiple modes and advanced features",
    icon: Video,
    available: true,
    features: ["Narrative Mode", "Character Vlog", "Ambient Visual", "10+ videos per campaign"],
  },
  {
    id: "stories" as const,
    name: "Stories Mode",
...
export function TypeSelectionStep({ value, onChange }: TypeSelectionStepProps) {
  return (
