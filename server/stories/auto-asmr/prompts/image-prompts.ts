/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * IMAGE GENERATION PROMPTS - AUTO-ASMR
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 ...
 * 
 * SPECIAL FOCUS: ASMR content requires visuals that are calming, satisfying,
 * and sensory-focused. Images should support the relaxation experience with
 * peaceful, detailed, and visually pleasing elements.
 * 
