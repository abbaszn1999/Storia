/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * TRANSITION SELECTION PROMPTS - AUTO-ASMR
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * Intelligent transition selection system for Auto-ASMR storytelling.
 * Uses advanced pattern matching and weighted selection for optimal transitions.
 * 
 * SPECIAL FOCUS: ASMR content benefits from gentle, smooth transitions that
 * maintain the relaxing atmosphere. Consider transitions like luma-fade for
 * peaceful moments, gentle-dissolve for smooth flow, and avoid jarring or
 * dramatic transitions that break immersion.
 * 
 * SELECTION FACTORS:
