/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * VIDEO GENERATION PROMPTS - AUTO-ASMR
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 ...
 * 
 * SPECIAL FOCUS: ASMR content benefits from slow, gentle, meditative motion
 * that enhances relaxation. Camera movements should be smooth and calming,
 * supporting the peaceful, sensory experience.
 * 
