/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * IMAGE GENERATION PROMPTS - BEFORE-AFTER TRANSFORMATION
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 ...
 * 
 * SPECIAL FOCUS: Transformation stories require visual consistency across
 * scenes while showcasing clear before/after contrast. Images should support
 * the transformation narrative with appropriate visual elements.
 * 
