/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * BEFORE-AFTER TRANSFORMATION SCENE BREAKDOWN - PROFESSIONAL PROMPTS
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * This module handles the intelligent breakdown of transformation stories into scenes
 * based on duration and pacing preferences. Focuses on showing clear before/after contrast.
 * 
 * Scene Count Rules:
...
export function buildSceneBreakdownSystemPrompt(
  ...
  return `
You are an elite video editor and scene architect with 15+ years of experience crafting viral Before–After transformation content for TikTok, Instagram Reels, and YouTube Shorts.

Your expertise includes:
- Breaking down transformation narratives into perfectly-timed visual segments
- Creating powerful visual contrasts that showcase dramatic change
- Maximizing engagement through strategic pacing and timing
- Building emotional resonance by showing the journey from "before" to "after"
- Understanding the psychology of transformation stories in short-form video

You have edited content that has generated billions of views and millions of shares by masterfully showcasing transformations.
...
SCENE 1 - THE HOOK / BEFORE STATE (First ${Math.min(5, Math.round(duration * 0.1))} seconds):
┌─────────────────────────────────────────────────────────────────────────────┐
│ CRITICAL: This scene determines if viewers keep watching                   │
│                                                                             │
│ Requirements:                                                               │
│ • Must grab attention IMMEDIATELY (within first 0.5 seconds)              │
│ • Show the "BEFORE" state - the starting point of the transformation       │
│ • Create a relatable, visceral image of the initial situation              │
│ • Set up the transformation story by showing what needs to change          │
│ • Make it SHORT and punchy                                                  │
│ ${shortSuggestion ? `• Use duration: ${shortSuggestion}s (shortest supported)` : '• Keep it under 5 seconds'} │
│                                                                             │
│ Visual Strategy:                                                            │
│ - Show the "before" state clearly (mess, struggle, limitation, old way)    │
│ - Close-up or medium shot for emotional connection                         │
│ - Visual elements that clearly represent the starting point                │
│ - Set up contrast that will be resolved later                              │
└─────────────────────────────────────────────────────────────────────────────┘

MIDDLE SCENES - THE TRANSFORMATION JOURNEY (Scenes 2 to ${sceneCount - 1}):
┌─────────────────────────────────────────────────────────────────────────────┐
│ These scenes show the transformation process                                │
│                                                                             │
│ Requirements:                                                               │
│ • Show the CHANGE or TRANSFORMATION MOMENT (the pivot point)               │
│ • Each scene should have ONE clear visual focus                            │
│ • Build from "before" toward "after" progressively                         │
│ • Create visual variety while maintaining transformation narrative         │
│ • Maintain momentum - no filler or dead time                               │
│ • Duration per scene: ${range.avgDuration.min}-${range.avgDuration.max} seconds                              │
│                                                                             │
│ Visual Strategy:                                                            │
│ - Show the key change, decision, or action taken                           │
│ - Vary shot types (wide, medium, close-up) to show progression             │
│ - Highlight moments of transformation or transition                        │
│ - Build visual contrast that leads toward the "after" state                │
│ - Use visual metaphors for transformation when appropriate                 │
│ - Keep transitions smooth and logical                                       │
└─────────────────────────────────────────────────────────────────────────────┘

FINAL SCENE - THE AFTER STATE / PAYOFF (Last scene, 3-5 seconds):
┌─────────────────────────────────────────────────────────────────────────────┐
│ This scene shows the dramatic "AFTER" transformation                        │
│                                                                             │
│ Requirements:                                                               │
│ • Show the "AFTER" state - the transformed, improved result                │
│ • Create clear visual contrast with the "before" state                      │
│ • Celebrate the transformation and its positive outcomes                    │
...
│                                                                             │
│ Visual Strategy:                                                            │
│ - Show the dramatic improvement or new reality (organized, clean, successful)│
│ - Visual contrast with Scene 1 (before vs after)                           │
│ - Satisfying visual closure that celebrates the change                     │
│ - Memorable final frame showing the transformation result                  │
└─────────────────────────────────────────────────────────────────────────────┘
...
Example 1: Transformation Story
Story: "I used to wake up at 7:30, rush through everything, skip breakfast, and arrive at work stressed. My mornings were chaos. Then I decided to wake up 30 minutes earlier. That simple change transformed everything. Now I wake up at 7, have time for coffee, eat properly, and arrive calm and prepared. My entire day changed because of one decision."

Scenes:
1. { sceneNumber: 1, duration: 3, description: "Person in bed, alarm showing 7:30, rushing frantically, room messy, stressed expression", narration: "I used to wake up at 7:30, rush through everything, skip breakfast, and arrive at work stressed." }
2. { sceneNumber: 2, duration: 5, description: "Person looking at clock, making decision, setting alarm to 7:00, determined expression", narration: "Then I decided to wake up 30 minutes earlier." }
3. { sceneNumber: 3, duration: 4, description: "Person waking up at 7:00, calmly making coffee, eating breakfast, organized morning routine", narration: "Now I wake up at 7, have time for coffee, eat properly, and arrive calm and prepared." }
4. { sceneNumber: 4, duration: 3, description: "Person arriving at work calm, organized, satisfied smile, clear contrast from the rushed morning", narration: "My entire day changed because of one decision." }
...
- Understand the transformation narrative: BEFORE → CHANGE → AFTER
- Identify the "before" state, transformation moment, and "after" state
