// ═══════════════════════════════════════════════════════════════════════════════
// SHARED TYPES - Used across story generation services
// ═══════════════════════════════════════════════════════════════════════════════
...
export interface ImageGeneratorInput {
  ...
  projectName: string;
  workspaceId: string;
  // Optional: Video model info for dimension matching
  videoModel?: string;          // Video model ID (e.g., "sora-2-pro") - used to determine matching dimensions
  videoResolution?: string;     // Video resolution (e.g., "720p") - used with videoModel for dimension matching
}
...
// Import from: import { SocialPlatform, SocialMetadataInput, SocialMetadataOutput } from "../social";
